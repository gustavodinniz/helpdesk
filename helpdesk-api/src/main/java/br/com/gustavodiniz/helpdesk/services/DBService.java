...
public class DBService {
    ...
    public void instanceDB() {
        ...
        Technician technician2 = new Technician(null, "João Gomes", "158.003.450-07", "joao@gmail.com", "123");
        Technician technician3 = new Technician(null, "Pedro Marcos", "028.250.600-46", "pedro@gmail.com", "123");
        Technician technician4 = new Technician(null, "Vinicius Oliveira", "476.932.950-46", "viniciues@gmail.com", "123");
        Technician technician5 = new Technician(null, "Leonardo Pereira", "174.843.150-10", "leonardo@gmail.com", "123");
        technician1.addProfile(Profile.ADMIN);

        Client client1 = new Client(null, "Alberto Chaves", "753.597.110-51", "alberto@gmail.com", "123");
        Client client2 = new Client(null, "Marisa Gomes", "502.999.840-36", "marisa@gmail.com", "123");
        Client client3 = new Client(null, "Erica Diniz", "530.684.940-79", "erica@gmail.com", "123");
        Client client4 = new Client(null, "Camila Diniz", "933.040.650-59", "camila@gmail.com", "123");
        Client client5 = new Client(null, "Antonio Gomes", "802.942.350-00", "antonio@gmail.com", "123");
        Client client6 = new Client(null, "Alessandro Mendes", "512.216.140-29", "alessandro@gmail.com", "123");
        Client client7 = new Client(null, "Gabriel Magno", "906.687.060-58", "gabriel@gmail.com", "123");
        Client client8 = new Client(null, "Ulisses Costa", "876.304.410-29", "ulisses@gmail.com", "123");
        Client client9 = new Client(null, "Everton Mendonça", "014.681.750-84", "everton@gmail.com", "123");
        Client client10 = new Client(null, "Maria Oliveira", "164.320.550-16", "maria@gmail.com", "123");
